...
export default function Home() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* HYBRID機能テスト表示 */}
      <div className="fixed top-20 right-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-4 py-2 rounded-full text-sm font-bold z-50 shadow-lg backdrop-blur-sm">
        🎯 {permissionState} | {initializationMode}
      </div>

      {isPermissionGranted && (
        <div className="fixed top-32 right-6 bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4 py-2 rounded-full text-xs font-bold z-50 shadow-lg backdrop-blur-sm">
          ✅ Permission Granted
        </div>
      )}
