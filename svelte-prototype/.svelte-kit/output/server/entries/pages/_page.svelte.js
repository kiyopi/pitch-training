...
const css$2 = {
  code: ".btn.svelte-ad033c{display:inline-flex;align-items:center;justify-content:center;font-weight:500;border-radius:8px;border:none;cursor:pointer;transition:all 0.2s ease;text-decoration:none;font-family:inherit}.btn.svelte-ad033c:disabled,.btn-disabled.svelte-ad033c{opacity:0.5;cursor:not-allowed}.btn-full.svelte-ad033c{width:100%}.btn-primary.svelte-ad033c{background:var(--color-primary);color:white}.btn-primary.svelte-ad033c:hover:not(:disabled){background:var(--color-primary-hover)}.btn-secondary.svelte-ad033c{background:var(--color-gray-100);color:var(--color-gray-700);border:1px solid var(--color-gray-200)}.btn-secondary.svelte-ad033c:hover:not(:disabled){background:var(--color-gray-200)}.btn-ghost.svelte-ad033c{background:transparent;color:var(--color-primary)}.btn-ghost.svelte-ad033c:hover:not(:disabled){background:var(--color-primary-pale)}.btn-sm.svelte-ad033c{padding:var(--space-2) var(--space-3);font-size:var(--text-sm)}.btn-md.svelte-ad033c{padding:var(--space-3) var(--space-4);font-size:var(--text-base)}.btn-lg.svelte-ad033c{padding:var(--space-4) var(--space-6);font-size:var(--text-lg)}",
  map: `{"version":3,"file":"Button.svelte","sources":["Button.svelte"],"sourcesContent":["<script lang=\\"ts\\">\\n  export let variant = 'primary';\\n  export let size = 'md';\\n  export let disabled = false;\\n  export let fullWidth = false;\\n  export let href = undefined;\\n<\/script>\\n\\n{#if href}\\n  <a \\n    {href}\\n    class=\\"btn\\"\\n    class:btn-primary={variant === 'primary'}\\n    class:btn-secondary={variant === 'secondary'}\\n    class:btn-ghost={variant === 'ghost'}\\n    class:btn-sm={size === 'sm'}\\n    class:btn-md={size === 'md'}\\n    class:btn-lg={size === 'lg'}\\n    class:btn-disabled={disabled}\\n    class:btn-full={fullWidth}\\n  >\\n    <slot />\\n  </a>\\n{:else}\\n  <button \\n    type=\\"button\\"\\n    {disabled}\\n    class=\\"btn\\"\\n    class:btn-primary={variant === 'primary'}\\n    class:btn-secondary={variant === 'secondary'}\\n    class:btn-ghost={variant === 'ghost'}\\n    class:btn-sm={size === 'sm'}\\n    class:btn-md={size === 'md'}\\n    class:btn-lg={size === 'lg'}\\n    class:btn-disabled={disabled}\\n    class:btn-full={fullWidth}\\n    on:click\\n  >\\n    <slot />\\n  </button>\\n{/if}\\n\\n<style>\\n  .btn {\\n    display: inline-flex;\\n    align-items: center;\\n    justify-content: center;\\n    font-weight: 500;\\n    border-radius: 8px;\\n    border: none;\\n    cursor: pointer;\\n    transition: all 0.2s ease;\\n    text-decoration: none;\\n    font-family: inherit;\\n  }\\n  \\n  .btn:disabled,\\n  .btn-disabled {\\n    opacity: 0.5;\\n    cursor: not-allowed;\\n  }\\n  \\n  .btn-full {\\n    width: 100%;\\n  }\\n  \\n  /* Variants */\\n  .btn-primary {\\n    background: var(--color-primary);\\n    color: white;\\n  }\\n  \\n  .btn-primary:hover:not(:disabled) {\\n    background: var(--color-primary-hover);\\n  }\\n  \\n  .btn-secondary {\\n    background: var(--color-gray-100);\\n    color: var(--color-gray-700);\\n    border: 1px solid var(--color-gray-200);\\n  }\\n  \\n  .btn-secondary:hover:not(:disabled) {\\n    background: var(--color-gray-200);\\n  }\\n  \\n  .btn-ghost {\\n    background: transparent;\\n    color: var(--color-primary);\\n  }\\n  \\n  .btn-ghost:hover:not(:disabled) {\\n    background: var(--color-primary-pale);\\n  }\\n  \\n  /* Sizes */\\n  .btn-sm {\\n    padding: var(--space-2) var(--space-3);\\n    font-size: var(--text-sm);\\n  }\\n  \\n  .btn-md {\\n    padding: var(--space-3) var(--space-4);\\n    font-size: var(--text-base);\\n  }\\n  \\n  .btn-lg {\\n    padding: var(--space-4) var(--space-6);\\n    font-size: var(--text-lg);\\n  }\\n</style>"],"names":[],"mappings":"AA2CE,kBAAK,CACH,OAAO,CAAE,WAAW,CACpB,WAAW,CAAE,MAAM,CACnB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,GAAG,CAChB,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,IAAI,CACZ,MAAM,CAAE,OAAO,CACf,UAAU,CAAE,GAAG,CAAC,IAAI,CAAC,IAAI,CACzB,eAAe,CAAE,IAAI,CACrB,WAAW,CAAE,OACf,CAEA,kBAAI,SAAS,CACb,2BAAc,CACZ,OAAO,CAAE,GAAG,CACZ,MAAM,CAAE,WACV,CAEA,uBAAU,CACR,KAAK,CAAE,IACT,CAGA,0BAAa,CACX,UAAU,CAAE,IAAI,eAAe,CAAC,CAChC,KAAK,CAAE,KACT,CAEA,0BAAY,MAAM,KAAK,SAAS,CAAE,CAChC,UAAU,CAAE,IAAI,qBAAqB,CACvC,CAEA,4BAAe,CACb,UAAU,CAAE,IAAI,gBAAgB,CAAC,CACjC,KAAK,CAAE,IAAI,gBAAgB,CAAC,CAC5B,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,gBAAgB,CACxC,CAEA,4BAAc,MAAM,KAAK,SAAS,CAAE,CAClC,UAAU,CAAE,IAAI,gBAAgB,CAClC,CAEA,wBAAW,CACT,UAAU,CAAE,WAAW,CACvB,KAAK,CAAE,IAAI,eAAe,CAC5B,CAEA,wBAAU,MAAM,KAAK,SAAS,CAAE,CAC9B,UAAU,CAAE,IAAI,oBAAoB,CACtC,CAGA,qBAAQ,CACN,OAAO,CAAE,IAAI,SAAS,CAAC,CAAC,IAAI,SAAS,CAAC,CACtC,SAAS,CAAE,IAAI,SAAS,CAC1B,CAEA,qBAAQ,CACN,OAAO,CAAE,IAAI,SAAS,CAAC,CAAC,IAAI,SAAS,CAAC,CACtC,SAAS,CAAE,IAAI,WAAW,CAC5B,CAEA,qBAAQ,CACN,OAAO,CAAE,IAAI,SAAS,CAAC,CAAC,IAAI,SAAS,CAAC,CACtC,SAAS,CAAE,IAAI,SAAS,CAC1B"}`
};
const Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${href ? `<a${add_attribute("href", href, 0)} class="${[
    "btn svelte-ad033c",
    (variant === "primary" ? "btn-primary" : "") + " " + (variant === "secondary" ? "btn-secondary" : "") + " " + (variant === "ghost" ? "btn-ghost" : "") + " " + (size === "sm" ? "btn-sm" : "") + " " + (size === "md" ? "btn-md" : "") + " " + (size === "lg" ? "btn-lg" : "") + " " + (disabled ? "btn-disabled" : "") + " " + (fullWidth ? "btn-full" : "")
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(PageLayout, "PageLayout").$$render($$result, { title: "Pitch Training App" }, {}, {
    default: () => {
      return `<div class="homepage svelte-w2netp"><div class="hero svelte-w2netp"><h1 class="hero-title svelte-w2netp" data-svelte-h="svelte-1h4goym">相対音感トレーニング</h1> <p class="hero-description svelte-w2netp" data-svelte-h="svelte-ukit5l">ドレミファソラシドの音程関係を正確に聞き分ける力を鍛えましょう</p></div> <div class="modes-grid svelte-w2netp">${validate_component(Card, "Card").$$render(
        $$result,
        {
          variant: "primary",
          padding: "lg",
